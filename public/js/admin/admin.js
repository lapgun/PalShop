...
var vue = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    getListUser: function getListUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('admin/list-user').then(function (res) {
    ...
    handleSubmit: function handleSubmit() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('admin/store', this.user).then(function (res) {
        _this2.getListUser();
    ...
    handleDeleteUser: function handleDeleteUser(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a["delete"]('admin/user/' + id).then(function (res) {
        _this3.$alert('Are you sure?', 'warning', 'warning');
