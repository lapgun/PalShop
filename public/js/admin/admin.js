  ...
  methods: {
    getListUser: function getListUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url, {
        ...
        _this.listUser = res.data.data.data;
    ...
    handleSubmit: function handleSubmit() {
      ...
      var urlStore = 'admin/store';
      var urlUpdate = 'admin/update';

      if (this.user.id == '') {
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(urlStore, this.user).then(function (res) {
          _this2.getListUser();
          ...
          _this2.$alert('Create successfully sent!', 'Success', 'success');
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(urlUpdate, this.user).then(function (res) {
          _this2.getListUser();
    ...
    handleDeleteUser: function handleDeleteUser(id) {
      var _this3 = this;

      var url = 'admin/user/';
      axios__WEBPACK_IMPORTED_MODULE_1___default.a["delete"](url + id).then(function (res) {
        _this3.$alert('Remove user success ?', 'Success', 'success');

        _this3.getListUser();
      })["catch"](function (error) {
        _this3.$alert('Remove user fail ?', 'Warning', 'warning');
      });
    },
