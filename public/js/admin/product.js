...
var vue = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  created: function created() {// this.getListUser();
  },
  mounted: function mounted() {
  ...
  methods: {
    ...
    handleCreate: function handleCreate() {
      $('#formUser').modal('show'); // this.clearForm();
    } //     handleUpdate(user) {
    //         $('#formUser').modal('show');
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Pal-Snaker\Pal-snaker\resources\js\admin\product.js */"./resources/js/admin/product.js");
